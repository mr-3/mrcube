...
class MR3CellMakerTest {
    ...
    private static final String DEFAULT_URI = "http://mrcube.ke.it.aoyama.ac.jp#";
    ...
    class InsertRDFResourceTest {
        ...
        void setUp() {
            ...
            var rdfGraphHandler = project.getInstanceEditor().getRdfGraphMarqueeHandler();
    ...
    class InsertRDFPropertyTest {
        ...
        void setUp() {
            ...
            project.getInstanceEditor().getGraph().setSelectionCell(cell1);
