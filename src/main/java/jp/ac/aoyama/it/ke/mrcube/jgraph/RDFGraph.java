...
import jp.ac.aoyama.it.ke.mrcube.actions.CopyAction;
import jp.ac.aoyama.it.ke.mrcube.actions.CutAction;
import jp.ac.aoyama.it.ke.mrcube.actions.PasteAction;
import jp.ac.aoyama.it.ke.mrcube.actions.SelectAllNodesAction;
...
public class RDFGraph extends JGraph {
    ...
    private final MR3Constants.GraphType type;
    private final GraphManager gmanager;

    public RDFGraph(GraphManager gm, GraphModel model, MR3Constants.GraphType type) {
    ...
    public MR3Constants.GraphType getType() {
        return type;
    }
