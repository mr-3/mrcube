...
class TreeAlgorithm {
    ...
    public void applyTreeAlgorithm(Collection<GraphLayoutData> graphNodes, GraphLayoutData selectedNode, MR3Constants.GraphType type) {
    ...
    public void setSeparation(MR3Constants.GraphType graphType) {
        switch (graphType) {
            case Instance:
                if (rootOrient_ == 'u') {
    ...
    private boolean compute(Collection<GraphLayoutData> graphNodes, GraphLayoutData root, MR3Constants.GraphType type) {
