...
import jp.ac.aoyama.it.ke.mrcube.actions.EditRDFPropertyAction;
...
class RDFGraphUI extends BasicGraphUI {
    ...
    private void changeLiteralCell(GraphCell cell, MR3Literal literal) {
        ...
        HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_LITERAL_WITH_GRAPH, beforeLiteral, newLiteral);
    }
    ...
    private void editLabel(GraphCell cell, Object info) {
        if (RDFGraph.isRDFResourceCell(cell)) {
            ...
            HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_RESOURCE_LABEL_WITH_GRAPH,
            ...
            HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_CLASS_LABEL_WITH_GRAPH,
            ...
            GraphUtilities.resizeRDFSResourceCell(gmanager, (RDFSModel) info, cell);
            gmanager.selectChangedRDFCells((RDFSModel) info);
            HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_ONT_PROPERTY_LABEL_WITH_GRAPH,
                    beforeInfo.getLabelList(), ((RDFSModel) info).getLabelList());
        }
    }
    ...
    private void editURI(GraphCell cell, Object info) {
        ...
        if (RDFGraph.isRDFResourceCell(cell)) {
            ...
            if (isValidResource(resource.getURI(), resInfo.getURIStr())) {
                ...
                HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_RESOURCE_WITH_GRAPH, beforeInfo, resInfo);
            } else {
                cancelAction(cell);
            }
        } else if (RDFGraph.isRDFPropertyCell(cell)) {
            ...
            if (!editRDFPropertyAction.editRDFProperty()) {
                ...
                HistoryManager.saveHistory(MR3Constants.HistoryType.EDIT_PROPERTY_WITH_GRAPH, beforePropURI,
