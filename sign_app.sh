...
ENTITLEMENTS=${1:-"/Users/morita/mrcube/entitlements.txt"}
...
# 署名対象のリスト（配列）
TARGETS=(
    "MRCube.app/Contents/runtime/Contents/Home/bin/jrunscript"
    **/*.jar
    **/**/java
    **/**/keytool
    **/**/jspawnhelper
    **/*.dylib
    "MRCube.app/Contents/MacOS/MRCube"
)
...
if [ -f "$DMG_NAME" ]; then
    ...
    BACKUP_NAME="mrcube-${VERSION}_${TIMESTAMP}.dmg"
