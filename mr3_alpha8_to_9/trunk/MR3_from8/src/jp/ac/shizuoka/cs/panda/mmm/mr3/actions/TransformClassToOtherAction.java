 ...
 */
public class TransformClassToOtherAction extends AbstractAction {
	...
	private RDFGraph graph;
		...
		public TransformClassToOtherAction(RDFGraph g, GraphManager gm, GraphType type) {
			super("Transform from Class to "+type);
			graph = g;
			gmanager = gm;
			graphType = type;
		}
