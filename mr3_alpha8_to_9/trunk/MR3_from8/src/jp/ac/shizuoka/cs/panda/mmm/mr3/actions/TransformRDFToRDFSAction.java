 ...
 */
public class TransformRDFToRDFSAction extends AbstractAction {
	...
	public TransformRDFToRDFSAction(RDFGraph g, GraphManager gm, GraphType type) {
		super("Transform from RDF to "+type);
		graph = g;
		gmanager = gm;
		graphType = type;
	}
