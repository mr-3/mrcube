...
public class ProgressDialog extends JDialog {
	...
	static String progress = "Progress"; /* #Finished */
	static String cancel = "Cancel"; /* #Finished */
	static String sum = "Sum"; /* #Finished */
	...
	public static void main(String[] args) {
		final ProgressDialog dlg = new ProgressDialog((Frame) null, progress, false);
	...
	private void jbInit() throws Exception {
		...
		lblMessage.setName(progress); /* #Finished */
		pnlProgress.setLayout(layProgress);

		lblProgressSum.setName(sum); /* #Finished */

		lblProgressSumVal.setHorizontalAlignment(SwingConstants.RIGHT);
		cmdCancel.setText(cancel);
		cmdCancel.setName(cancel); /* #Finished */
		...
		pnlProgress.add(
			lblProgressSum,
			new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 25, 0));
		pnlProgress.add(
			pbProgressSum,
			new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 50, 0));
		pnlProgress.add(
			lblProgressSumVal,
			new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 25, 0));
		...
		this.setBounds((screenWidth - 400) / 2, (screenHeight - 100) / 2, 400, 100);
	...
	public void setValue(int value) {
		...
		lblProgressSumVal.setText(java.text.NumberFormat.getInstance().format(Math.round(pbProgressSum.getPercentComplete() * 100)) + "%");
	}
