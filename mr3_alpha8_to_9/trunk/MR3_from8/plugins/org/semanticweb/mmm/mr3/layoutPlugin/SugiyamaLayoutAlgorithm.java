...
public class SugiyamaLayoutAlgorithm {
	 ...
	 */
	protected ProgressDialog dlgProgress = new ProgressDialog((Frame) null, "Progress" + ":", false); /* #Finished */
	 ...
	 *
	 */
	public void perform(JGraph jgraph, boolean applyToAll, Point s) {
	...
	protected Vector searchRoots(JGraph jgraph, CellView[] selectedCellViews) {
		...
		if (roots.size() == 0) {
			JOptionPane.showMessageDialog(null, "TheGraphIsNotADAG"
	...
	protected void solveEdgeCrosses(JGraph jgraph, Vector levels) {
		dlgProgress.setMessage("SolvingCrossOverPoints" /*#Finished:Original="solving cross over points ..."*/
		);
