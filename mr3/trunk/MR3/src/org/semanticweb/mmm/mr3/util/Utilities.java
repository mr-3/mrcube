...
public class Utilities {
    ...
    public static Literal createLiteral(String value, String lang, RDFDatatype dataType) {
        ...
        if (dataType == null) { return model.createLiteral(value, lang); }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org/123")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org#123")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org/abc")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org#abc")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org/123abc")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org#123abc")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org/")));
        System.out.println(Utilities.getNameSpace(ResourceFactory.createResource("http://example.org#")));
        ...
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org/123")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org#123")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org/abc")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org#abc")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org/123abc")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org#123abc")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org/")));
        System.out.println(Utilities.getLocalName(ResourceFactory.createResource("http://example.org#")));
    }
}
