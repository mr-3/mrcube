...
public class ExportDialog extends JDialog implements ActionListener {
    ...
    private static LessPager lessPager;
    ...
    public ExportDialog(GraphManager gm) {
        ...
        exportButtonPanel.setBorder(BorderFactory
                .createTitledBorder(Translator.getString("Component.File.Export.Text")));
        ...
        // treePanel = new MR3TreePanel(gmanager);
        // treePanel.addTreeSelectionListener(this);
        // JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
        // treePanel, sourcePane);
    ...
    // class ExportEPSEvent implements ActionListener {
    // public void actionPerformed(ActionEvent e) {
    // if (getSelectedCount() != 1) {
    // JOptionPane.showMessageDialog(gmanager.getDesktop(), "Check (RDF or Class
    // or Property)", "",
    ...
    // String eps = null;
    // if (rdfConvertBox.isSelected() &&
    // gmanager.getRDFGraph().getModel().getRootCount() > 0) {
    // eps = GPConverter.toEPS(gmanager.getRDFGraph());
    // } else if (classConvertBox.isSelected() &&
    // gmanager.getClassGraph().getModel().getRootCount() > 0) {
    // eps = GPConverter.toEPS(gmanager.getClassGraph());
    // } else if (propertyConvertBox.isSelected() &&
    // gmanager.getPropertyGraph().getModel().getRootCount() > 0) {
    // eps = GPConverter.toEPS(gmanager.getPropertyGraph());
    // }
    // if (eps != null) {
    ...
    // }
    //
    // class ExportPDFEvent implements ActionListener {
    // public void actionPerformed(ActionEvent e) {
    // if (getSelectedCount() != 1) {
    // JOptionPane.showMessageDialog(gmanager.getDesktop(), "Check (RDF or Class
    // or Property)", "",
    ...
    // if (rdfConvertBox.isSelected() &&
    // gmanager.getRDFGraph().getModel().getRootCount() > 0) {
    // GPConverter.toPDF(gmanager.getRDFGraph(), file);
    // } else if (classConvertBox.isSelected() &&
    // gmanager.getClassGraph().getModel().getRootCount() > 0) {
    // GPConverter.toPDF(gmanager.getClassGraph(), file);
    // } else if (propertyConvertBox.isSelected() &&
    // gmanager.getPropertyGraph().getModel().getRootCount() > 0) {
    // GPConverter.toPDF(gmanager.getPropertyGraph(), file);
    // }
    // }
    // }
    ...
    private String getExtension() {
        if (xmlRadioButton.isSelected()) {
            ...
            return "n3";
        } else if (turtleRadioButton.isSelected()) { return "ttl"; }
        return "rdf";
    }
    ...
    private void writeModelToPager(Model model) {
        ...
        lessPager.setText(writer.toString());
    }

    private String getConvertType() {
        if (xmlRadioButton.isSelected()) {
            if (abbrevCheckBox.isSelected()) { return "RDF/XML-ABBREV"; }
            return "RDF/XML";
            ...
            return "N-TRIPLE";
        } else if (turtleRadioButton.isSelected()) { return "TURTLE"; }
        return "RDF/XML";
    }
    ...
    // String resource = path.getLastPathComponent().toString();
    //
    ...
    // lessPager.setSearchWord(resource);
    // } else {
    // PrefixNSUtil.setPrefixNSInfoSet(gmanager.getPrefixNSInfoSet());
    // String ns = PrefixNSUtil.getNameSpace(prefix);
    // // System.out.println("prefix: "+prefix);
    // // System.out.println("ns: "+ ns);
    // // System.out.println(ns+id);
    // if (ns.equals(gmanager.getBaseURI())) {
    // // System.out.println("rdf:ID=\""+id+"\"");
    // lessPager.setSearchWord("rdf:ID=\"" + id + "\"");
    // } else {
    // lessPager.setSearchWord(ns + id);
    // }
    // }
    // lessPager.search();
    // }
    ...
    public void setFont(Font font) {
        super.setFont(font);
        lessPager.setFont(font);
    }

    public static void setText(String text) {
        lessPager.setText(text);
    }
