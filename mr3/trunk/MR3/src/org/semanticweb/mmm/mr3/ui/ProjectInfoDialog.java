...
public class ProjectInfoDialog extends JDialog {
    ...
    public void resetStatus() {
        ...
        ontClassCntValue.setText(new Integer(calcOntCnt(gmanager.getClassGraph())).toString());
        ontPropertyCntValue.setText(new Integer(calcOntCnt(gmanager.getPropertyGraph())).toString());
