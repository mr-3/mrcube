        ...
        public class ChooseFontAction extends AbstractAction {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (result == JFontChooser.OK_OPTION) {
                    ...
                    setGraphFont(gmanager.getRDFGraph(), font);
                    setGraphFont(gmanager.getClassGraph(), font);
                    setGraphFont(gmanager.getPropertyGraph(), font);
                }
            }
    ...
    class DecideAction extends AbstractAction {
        ...
        private void setConfig() {
            try {
                ...
                JOptionPane.showMessageDialog(gmanager.getDesktop(), "Number Format Exception", "Warning",
