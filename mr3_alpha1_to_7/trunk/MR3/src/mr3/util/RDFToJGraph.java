...
public class RDFToJGraph {
	...
	public RDFToJGraph(GraphManager manager) {
		gmanager = manager;
...
//		System.out.println(uri);
		...
		} else if (uri.getNameSpace().equals(gmanager.getBaseURI()+"#")) { // 手抜き
	...
	private void insertGroup(GraphModel model, Object cell, Object typeCell, Map attr) {
		//		ParentMap parentMap = new ParentMap(); // 2.0系
